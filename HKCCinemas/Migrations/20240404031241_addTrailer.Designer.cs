...
namespace HKCCinemas.Migrations
{
    ...
    [Migration("20240404031241_addTrailer")]
            ...
            modelBuilder.Entity("HKCCinemas.Models.Trailer", b =>
                {
                    ...
                    b.Property<string>("Trailer1")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("Trailer2")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("Trailer3")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("HKCCinemas.Models.Trailer", b =>
                {
                    b.HasOne("HKCCinemas.Models.Film", "Film")
                        .WithOne("Trailer")
                        .HasForeignKey("HKCCinemas.Models.Trailer", "FilmId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
