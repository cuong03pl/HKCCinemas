...
namespace HKCCinemas.Migrations
{
    ...
    [Migration("20240611152821_updateSchedule116")]
    partial class updateSchedule116
    {
            ...
            modelBuilder.Entity("HKCCinemas.Models.Schedule", b =>
                {
                    ...
                    b.HasOne("HKCCinemas.Models.ShowDate", null)
                        .WithMany("Schedules")
                        .HasForeignKey("ShowDateId1");
